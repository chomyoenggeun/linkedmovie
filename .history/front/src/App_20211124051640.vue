<template>
  <div id="app">
    <div id="nav">
      <ul class="horizontal">
        <li><router-link class="active" to="/home">LOGO</router-link></li>
        ...
        <li v-else class="rightli" style="float:right"><router-link class="menubt" to="/account">Account</router-link></li>
      </ul>
