<template>
  <div>
    ...
    <div>
      ...
      <div>
        <h1>{{ randomMovie }} 장르명</h1>
        <div>
          <!-- <span v-for="randomMovieItem in randomMovie"
          :key="randomMovieItem.id">
            <img :src="`https://image.tmdb.org/t/p/original${randomMovieItem.poster_path}`" class="image-size-random">
          </span> -->
        </div>
      </div>
    </div>
